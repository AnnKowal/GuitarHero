...
void TPM0_IRQHandler(void) {
	if (probka > dlugosc ) {
		...
		if (upSampleCNT == 0){
			...
			TPM0->CONTROLS[2].CnV = piosenka2[probka_do_odt]; 
		}	
		if (probka > dlugosc ) {
			play = 0;         
			TPM0->CONTROLS[2].CnV = 0;
		...
		if (upSampleCNT == 0){
			probka_do_odt=probka++;
			TPM0->CONTROLS[2].CnV = piosenka4[probka_do_odt]; 
		}	
		if (probka > dlugosc ) {
			play = 0;         
			TPM0->CONTROLS[2].CnV = 0;
		...
		if (upSampleCNT == 0){
			probka_do_odt=probka++;
			TPM0->CONTROLS[2].CnV = piosenka5[probka_do_odt]; 
		}	
		if (probka > dlugosc ) {
			play = 0;         
			TPM0->CONTROLS[2].CnV = 0;
		...
		if (upSampleCNT == 0){
			probka_do_odt=probka++;
			TPM0->CONTROLS[2].CnV = piosenka6[probka_do_odt]; 
		}	
		if (probka > dlugosc ) {
			play = 0;         
			TPM0->CONTROLS[2].CnV = 0;
